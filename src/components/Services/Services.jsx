        ...
        <li className="servicesSection">
            <ul>
                <NavLink className="navLink" to="../ServicesPage" >
                    <li className="link">
                        <img src="/img/services.svg" alt="Category"/>Services
                    </li>
                </NavLink>
            </ul>
            <section className="servicesContainer" id="servicesContainer">
                <div className="servicesColumn">
                    <article className="infoServices">
                        <img src="/img/installation.svg" alt="Icon" className="iconServices" />
                        <div className="info">
                    ...
                    <article className="infoServices">
                    <img src="/img/advice.svg" alt="Icon" className="iconServices" />
                        <div className="info">
                    ...
                    <article className="infoServices">
                    <img src="/img/product.svg" alt="Icon" className="iconServices" />
                        <div className="info">
                    ...
                    <article className="infoServices">
                    <img src="/img/training.svg" alt="Icon" className="iconServices" />
                        <div className="info">
                    ...
                    <article className="infoServices">
                    <img src="/img/postSale.svg" alt="Icon" className="iconServices" />
                        <div className="info">
                ...
                <div className="servicesColumn">
                    ...
                    <article className="infoServices">
                        <img src="/img/loyalty.svg" alt="Icon" className="iconServices" />
                        <div className="info">
                    ...
                    <article className="infoServices">
                        <img src="/img/pickUp.svg" alt="Icon" className="iconServices" />
                        <div className="info">
                    ...
                    <article className="infoServices">
                        <img src="/img/events.svg" alt="Icon" className="iconServices" />
                        <div className="info">
                    ...
                    <article className="infoServices">
                        <img src="/img/warranty.svg" alt="Icon" className="iconServices" />
                        <div className="info">
